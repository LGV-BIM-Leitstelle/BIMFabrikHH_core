...
from BIMFabrikHH.apps.trees.basic.baum_manager import BaumManager
...
from BIMFabrikHH.core.data_processing.df_parser import DfParser
from BIMFabrikHH.data_models.params_tree import RequestParams, BoundingBoxParams, Container, Component
...
class TreeExporter:
    ...
    def __init__(self):
        # Always use the output directory at the project root, relative to this script
        self.output_dir = (Path(__file__).resolve().parent.parent.parent / "output").resolve()
        self.output_dir.mkdir(exist_ok=True)

        # Initialize common components
        self.df_parser = DfParser()
    ...
    def export_basic_trees(self, tree_data: Dict, output_file: str = "output_trees_basic.ifc"):
        ...
        bbox_params = BoundingBoxParams(
            min_x=9.9756,  # longitude
            min_y=53.5522,  # latitude  
            max_x=9.9789,  # longitude
            max_y=53.5536   # latitude
        )
        container = Container(
